...
# Drop the original 'Country' and 'Status' columns 
...
df_with_encoded.to_csv('processeddataset.csv', index=False)


# splitting data
# Step 1: Separate input features (X) and output feature (y)
X = df_with_encoded.drop(columns=["Life expectancy "])  # Input features
y = df_with_encoded["Life expectancy "]  # Output feature
